    ...
    <View style={styles.screen}>
      ...
      >
        {tickets.length === 0 ? (
          ...
          tickets.map((ticket) => {
            ...
            const proofs = proofMap[ticket.id] || [];

            return (
              <View key={ticket.id} style={styles.card}>
                <View style={[styles.cardLeft, { backgroundColor: cfg.color }]} />
                ...
                <View style={styles.cardContent}>
                  ...
                  <View style={styles.infoRow}>
                    ...
                    <Text style={styles.infoValue} numberOfLines={1}>{ticket.class_name || "Unknown class"}</Text>
                  </View>
                  <View style={styles.infoRow}>
                    <Text style={styles.infoLabel}>Course Code:</Text>
                    <Text style={styles.infoValue} numberOfLines={1}>{ticket.class_code || "N/A"}</Text>
                  </View>
                  <View style={styles.infoRow}>
                    <Text style={styles.infoLabel}>Faculty:</Text>
                    <Text style={styles.infoValue} numberOfLines={1}>{ticket.faculty_name || "Not assigned"}</Text>
                  </View>
                  ...
                  <View style={styles.noteWrap}>
                    ...
                    <Text style={styles.noteText} numberOfLines={2}>{ticket.teacher_notes || "No resolution note yet."}</Text>
                  </View>
                  ...
                  <View style={styles.proofStrip}>
                    {proofs.length > 0 ? (
                      ...
                      <Text style={styles.noProofText}>No proofs uploaded</Text>
                    )}
                  </View>
                </View>
              </View>
      ...
      {previewImageUrl && (
        <View style={styles.previewOverlay}>
          <TouchableOpacity style={styles.previewBackdrop} onPress={() => setPreviewImageUrl(null)} />
...
const styles = StyleSheet.create({
  ...
  desc: { marginTop: 10, fontSize: 14, color: "#1f2937", lineHeight: 20, minHeight: 40 },
  ...
  noteWrap: { marginTop: 10, backgroundColor: "#f9fafb", borderRadius: 8, padding: 10, minHeight: 56 },
  ...
  noProofText: { fontSize: 12, color: "#9ca3af" },
  previewOverlay: {
    position: "absolute",
    top: 0,
    left: 0,
